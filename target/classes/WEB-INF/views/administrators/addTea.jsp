...
%>
<div class="formdiv">
    <form id="contact" action="<%=basePath%>administrators/addteacher" method="post">
        <h4>增加老师</h4>
        <h4 style="color:red;">${msg}</h4>
        <fieldset>
            <input placeholder="编号" type="text" name="userid" id="userid" tabindex="1" required autofocus>
        </fieldset>
        <fieldset>
